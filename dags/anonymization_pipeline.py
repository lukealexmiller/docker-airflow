...
t_face_blur = BashOperator( # TODO: Add queue assignment
        task_id='tensorflow_face_blur',
        bash_command=tensorflow_face_blur,
        params={'gpu': 0,
                'cfg': '/usr/local/airflow/faster_rcnn/experiments/cfgs/faster_rcnn_end2end_wider.yml', #TODO: move
...
t_face_blur.set_upstream([t_split_to_frames_write_to_server])
